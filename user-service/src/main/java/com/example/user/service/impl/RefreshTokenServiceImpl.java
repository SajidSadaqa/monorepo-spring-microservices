...
@Service
public class RefreshTokenServiceImpl implements com.example.user.service.RefreshTokenService {

  private final RefreshTokenRepository tokens;
  private final UserRepository users;
  private final JwtService jwt;

  public RefreshTokenServiceImpl(RefreshTokenRepository tokens, UserRepository users, JwtService jwt) {
    this.tokens = tokens;
    this.users = users;
    this.jwt = jwt;
  }
